...
public class RegistroFertilidad extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
            ...
            txtCantProducida.getText().isEmpty() || txtObservaciones.getText().isEmpty())
        {
            ...
            Modelo.MetodosFertilidad fertilidad = new Modelo.MetodosFertilidad();
            ...
            if(fertilidad.IngresoRegFertilidad(id_animal, calidad, cantProducida, fechaRev, obversaciones))
            {
